...
class BrandController extends BaseController
{
    ...
    public function update (Request $request){
        ...
        if(!$brand){
            return $this->responseRedirectBack('Error Occured While updating this brand','error',true,true);
        }
        return $this->responseRedirect('admin.brands.index','brand updated successfuly','success',false,false);
    }
